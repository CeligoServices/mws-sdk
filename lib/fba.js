...
var complex = exports.complex = {
    ...
    PartneredSmallParcelDataPackageList: function() {
        var obj = new mws.ComplexList('PackageList.member');
    ...
    inbound: {
        ...
        PutTransportContent:function() {
            return new FbaInboundRequest('PutTransportContent', {
                ...
                PartneredSmallParcelDataPackageList: { name: 'TransportDetails.PartneredSmallParcelData.PackageList', type: 'Complex', required: true, construct: complex.PartneredSmallParcelDataPackageList },
                NonPartneredSmallParcelDataCarrierName: { name: 'TransportDetails.NonPartneredSmallParcelData.CarrierName', required: true },
                NonPartneredSmallParcelDataPackageList: { name: 'TransportDetails.NonPartneredSmallParcelData.PackageList', type: 'Complex', required: true, construct: complex.NonPartneredSmallParcelDataPackageList },
            });
        },
